...
// Derive le statut HTTP de l'erreur pour le rendu SSR.
const statusCode = computed(() => (useError().value?.statusCode ? Number(useError().value?.statusCode) : 404));

// Applique le status HTTP sur le serveur pour rester neutre et propre.
