<template>
  <JourneyLayout>
    <div class="pp-journey-panel space-y-4" role="region" aria-labelledby="journey-step-heading-B2_bilan">
      <JourneyStepHeader
        :title="blockCopy.bilanTitle"
        :subtitle="blockCopy.bilanSubtitle || blockCopy.subtitle"
        heading-id="journey-step-heading-B2_bilan"
      />
      <div v-if="hasScores" class="pp-journey-section space-y-3">
        <section class="space-y-2" aria-labelledby="b2-summary-heading">
          <h2 id="b2-summary-heading" class="pp-journey-title text-lg">
        ...
        <section class="space-y-2" aria-labelledby="b2-interpretation-heading">
          <h2 id="b2-interpretation-heading" class="pp-journey-title text-lg">
