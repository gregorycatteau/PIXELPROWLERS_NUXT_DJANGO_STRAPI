<template>
  <JourneyLayout>
    <div class="pp-journey-panel space-y-4" role="region" aria-labelledby="journey-step-heading-B1_questions">
      <JourneyStepHeader
...
const handleValidate = () => {
  ...
  storage.saveMeta({ lastStepId: 'B1_bilan', completedBlocks: Array.from(completed) });
