...
import P3IntroE0 from '~/components/journey/p3/P3IntroE0.vue';
import P3PanoramaE1 from '~/components/journey/p3/P3PanoramaE1.vue';
import P3PanoramaBilanE2 from '~/components/journey/p3/P3PanoramaBilanE2.vue';
import P3GlobalBilan from '~/components/journey/p3/P3GlobalBilan.vue';
...
const { currentStepId, goToStep } = useJourneyEngine({ journeyId: 'p3' });
const { meta, scores, loadFromStorage, clearAll, saveMeta } = useCoreJourneyStorage({ journeyId: 'p3' });

const allowedSteps = computed(() => p3JourneySchema.steps.map((step) => step.stepId));
...
const componentsMap: Record<string, any> = {
  E0_intro: P3IntroE0,
  E1_panorama: P3PanoramaE1,
  E2_panorama_bilan: P3PanoramaBilanE2,
  E_global_bilan: P3GlobalBilan
};

const currentComponent = computed(() => componentsMap[currentStepId.value] ?? P3IntroE0);
