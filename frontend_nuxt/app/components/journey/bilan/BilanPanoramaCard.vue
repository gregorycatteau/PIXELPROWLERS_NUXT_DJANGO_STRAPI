<template>
  <section id="gb_panorama" class="pp-globalbilan-section">
    <PPSectionHeader
      as="h2"
      density="compact"
      title="Panorama & blocs"
    />
    <div class="grid gap-5 lg:grid-cols-2">
      <PPCard as="div" variant="default" class="space-y-4">
        ...
        <PPCard as="div" variant="default" class="space-y-2 px-3 py-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 min-w-0">
          <PPCard
            ...
            as="div"
            variant="soft"
            class="h-full w-full min-w-0 flex flex-col gap-3 p-4"
          >
