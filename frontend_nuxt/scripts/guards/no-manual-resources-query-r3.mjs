...
// no-manual-resources-query-r3:guard
//
...
//
// R3 SCOPE ÉLARGI : Protection complète Bilan + Recos + journeySlug + Library
//
// PATTERNS INTERDITS :
...
//
// OK si usage de buildResourcesDeepLink(...) ou safeRoutePath('/ressources') sans query
//
// SCOPE R3 : Fichiers Bilan, Recos, journeySlug, Library (12 fichiers)
// - Bilan components
// - Resources library
// - Page parcours
// - Composable central
...
const SCAN_FILES = [
  ...
  'components/journey/bilan/BilanLandingPanel.vue',
  'components/journey/bilan/BilanHypothesesSection.vue',
  'components/journey/bilan/BilanPanoramaCard.vue',
  
  // === P1 specific bilan (R3) ===
  'components/journey/p1/P1GlobalBilan.vue',
  'components/journey/p1/P1GlobalBilanAside.vue',
  'components/journey/p1/P1BlocksHub.vue',
]
...
/**
 * Collect files to scan (scope explicite — fichiers protégés)
 */
...
function main() {
  console.log('🔍 no-manual-resources-query-r3:guard — Checking for manual /ressources query construction (R3 full scope)...\n')
  ...
  if (errors.length > 0) {
    console.log('❌ no-manual-resources-query-r3:guard — FAIL\n')
  ...
  console.log(`✅ no-manual-resources-query-r3:guard — OK (${files.length} files scanned)`)
