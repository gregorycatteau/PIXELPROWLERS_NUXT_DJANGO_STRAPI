...
## But du parcours
Le parcours P4 propose un panorama court pour clarifier la situation et poser un diagnostic simple, sans promesse avancee. Il sert de base jouable en dev et reste volontairement sobre.
