...
## Cartes (format : id / title / body / firstChecks)

### 1) mission_cash
- title: "Arbitrage mission ↔ cash : est-ce écrit ?"
- body: "Quand mission et financement se contredisent, si l’arbitrage n’est pas formalisé, la structure se déchire… et ça ressort en tensions humaines."
- firstChecks:
...
### 3) dependance_mortelle
- title: "Point de dépendance mortel : est-ce identifié ?"
- body: "Une dépendance forte (financeur, personne clé, presta, outil) transforme chaque imprévu en crise. Le système devient fragile."
- firstChecks:
...
- body: "Sans indicateur simple de capacité (énergie, charge, turnover, disponibilité), la structure se met en mode pompier et s’épuise."
- firstChecks:
...
### 5) pilotage_reporting
- title: "Pilotage : absence ou toxicité ?"
- body: "Quand il n’y a pas de pilotage lisible, ou un reporting vécu comme contrôle, la réalité remonte mal… et les erreurs explosent."
- firstChecks:
...
### 6) controles_internes
- title: "Contrôles internes : quelle faille évidente ?"
- body: "Quand les contrôles sont faibles, la structure devient vulnérable : erreurs, incidents, fraudes, cybersécurité bancale. Ça finit toujours en crise humaine."
- firstChecks:
...
Note : ces cartes sont des vérifications, pas un diagnostic médical. Elles servent à orienter l’attention vers le système.
